...
- **Reusable components**:
  - `HistoryTable` — year/month/content table used for education, work history, and licenses. Accepts `showCurrent` and `showEnd` boolean props to append "現在に至る" / "以上" rows
